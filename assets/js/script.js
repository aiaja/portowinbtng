// Sumber dari beberapa dokumentasi
...
// Buka sheet ketika button 'open sheet' diklik
...
// Sembunyikan sheet ketika button close diklik
sheet.querySelector('.close-sheet').addEventListener('click', () => {
  setIsSheetShown(false);
});

// Sembunyikan sheet ketika background diklik
...
var animation1 = bodymovin.loadAnimation({
  ...
  // path: 'https://assets.kuh.my.id/dncc/js/lottieflow-attention-07-000000-easey.json',
  rendererSettings: {
